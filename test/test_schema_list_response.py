    ...
    def make_instance(self, include_optional) -> SchemaListResponse:
        ...
        if include_optional:
            return SchemaListResponse(
                head = '',
                schemas = [
                    permify_async.models.schema_list_provides_a_list_of_schema_versions_with_their_corresponding_creation_timestamps.SchemaList provides a list of schema versions with their corresponding creation timestamps(
                        version = '', 
                        created_at = '', )
                    ],
                continuous_token = ''
