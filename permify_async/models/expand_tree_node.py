...
class ExpandTreeNode(BaseModel):
    ...
    """ # noqa: E501
    operation: Optional[ExpandTreeNodeOperation] = ExpandTreeNodeOperation.OPERATION_UNSPECIFIED
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "operation": obj.get("operation") if obj.get("operation") is not None else ExpandTreeNodeOperation.OPERATION_UNSPECIFIED,
